...
#Sulman et al. 2019
surf_ori = Dataset('/home/renato/datasets/sulman_2019/Global-data/ECM_obs_Sulman.nc','r')
...
lat = surf_ori.variables['lat'][:]
lon = surf_ori.variables['lon'][:]
...
for i in xrange(1):
   ...
   plt.savefig('ecm_orig_soudzi_0p16x0p16_larger_v2.png',bbox_inches="tight")
   plt.show()
