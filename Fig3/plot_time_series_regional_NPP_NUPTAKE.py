...
ax1.plot(time_future[2:732] + end + (30*12*5),y_av_stein4[2:732] + 4.,'r--')
ax1.plot(time_future[2:732] + end + (30*12*5),y_av_trop_stein4[2:732] + 2.,'g--')
ax1.plot(time_future[2:732] + end + (30*12*5),y_av_extratrop_stein4[2:732] + 2.,'b--')

##### AV1 IS NPP
#ax1.plot(time,y_av1,'r',label='NPP')
#ax1.plot(time,y_av1_trop,'g',label='Tropical')
#ax1.plot(time,y_av1_extratrop,'b',label='Extra-Tropical')
#ax1.plot(time,y_av1_stein1,'r',alpha=0.3)
#ax1.plot(time,y_av1_trop_stein1,'g',alpha=0.3)
#ax1.plot(time,y_av1_extratrop_stein1,'b',alpha=0.3)
#ax1.plot(time,y_av1_stein2,'r',alpha=0.4)
#ax1.plot(time,y_av1_trop_stein2,'g',alpha=0.4)
#ax1.plot(time,y_av1_extratrop_stein2,'b',alpha=0.4)
#ax1.plot(time,y_av1_stein3,'r',alpha=0.5)
#ax1.plot(time,y_av1_trop_stein3,'g',alpha=0.5)
#ax1.plot(time,y_av1_extratrop_stein3,'b',alpha=0.5)
#ax1.plot(time_future[1:732] + end + (30*12*5),y_av1_stein4[1:732] + 4.,'r--')
#ax1.plot(time_future[1:732] + end + (30*12*5),y_av1_trop_stein4[1:732] + 2.,'g--')
#ax1.plot(time_future[1:732] + end + (30*12*5),y_av1_extratrop_stein4[1:732] + 2.,'b--')

print(time_future,np.shape(time_future))
...
ax1.set_ylabel(r'NPP used for N Uptake (PgC.yr$^{-1}$)')
#plt.xlabel('year')
ax1.set_xlabel('year')
#best location
...
#vector1 = [y_av1,y_av1_stein4+4.]
#vector2 = [y_av1_trop,y_av1_trop_stein4+2.]
#vector3 = [y_av1_extratrop,y_av1_extratrop_stein4+2.]

#sns.boxplot(data = vector1,palette="Reds_r",ax=ax2)
#sns.boxplot(data = vector2,palette=my_pal2,ax=ax2)
#sns.boxplot(data = vector3,palette=my_pal3,ax=ax2)
...
#plt.title('US - UMB')
plt.savefig('regional_NPP_NUPTAKE.png',bbox_inches="tight")
plt.show()
