...
##### AV1 IS NPP
ax1.plot(time[0:1930],y_av1[0:1930],'r',label='Global')
ax1.plot(time[0:1930],y_av1_trop[0:1930],'g',label='Tropical')
ax1.plot(time[0:1930],y_av1_extratrop[0:1930],'b',label='Extra-Tropical')
ax1.plot(time[0:1930],y_av1_stein1[0:1930],'r',alpha=0.3)
ax1.plot(time[0:1930],y_av1_trop_stein1[0:1930],'g',alpha=0.3)
ax1.plot(time[0:1930],y_av1_extratrop_stein1[0:1930],'b',alpha=0.3)
ax1.plot(time[0:1930],y_av1_stein2[0:1930],'r',alpha=0.4)
ax1.plot(time[0:1930],y_av1_trop_stein2[0:1930],'g',alpha=0.4)
ax1.plot(time[0:1930],y_av1_extratrop_stein2[0:1930],'b',alpha=0.4)
ax1.plot(time[0:1930],y_av1_stein3[0:1930],'r',alpha=0.5)
ax1.plot(time[0:1930],y_av1_trop_stein3[0:1930],'g',alpha=0.5)
ax1.plot(time[0:1930],y_av1_extratrop_stein3[0:1930],'b',alpha=0.5)
ax1.plot(time_future[3:731] + end + (30*12*5),y_av1_stein4[3:731] -2.,'r--')
ax1.plot(time_future[3:731] + end + (30*12*5),y_av1_trop_stein4[3:731] + 2.,'g--')
ax1.plot(time_future[3:731] + end + (30*12*5),y_av1_extratrop_stein4[3:731] -2.,'b--')
...
#plt.title('US - UMB')
plt.savefig('regional_NPP.png',bbox_inches="tight")
plt.show()
