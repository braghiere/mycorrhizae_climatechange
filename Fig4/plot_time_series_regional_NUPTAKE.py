...
##### AV1 IS NUPTAKE
ax1.plot(time,y_av2,'r',label='Global')
ax1.plot(time,y_av2_trop,'g',label='Tropical')
ax1.plot(time,y_av2_extratrop,'b',label='Extra-Tropical')
ax1.plot(time,y_av2_stein1,'r',alpha=0.3)
ax1.plot(time,y_av2_trop_stein1,'g',alpha=0.3)
ax1.plot(time,y_av2_extratrop_stein1,'b',alpha=0.3)
ax1.plot(time,y_av2_stein2,'r',alpha=0.4)
ax1.plot(time,y_av2_trop_stein2,'g',alpha=0.4)
ax1.plot(time,y_av2_extratrop_stein2,'b',alpha=0.4)
ax1.plot(time,y_av2_stein3,'r',alpha=0.5)
ax1.plot(time,y_av2_trop_stein3,'g',alpha=0.5)
ax1.plot(time,y_av2_extratrop_stein3,'b',alpha=0.5)
ax1.plot(time_future[3:732] + end + (30*12*5),y_av2_stein4[3:732] - 60.,'r--')
ax1.plot(time_future[3:732] + end + (30*12*5),y_av2_trop_stein4[3:732] + 50.,'g--')
ax1.plot(time_future[3:732] + end + (30*12*5),y_av2_extratrop_stein4[3:732] - 70.,'b--')
...
ax1.set_ylabel(r'N Uptake (TgN.yr$^{-1}$)')
#plt.xlabel('year')
ax1.set_xlabel('year')
#best location
...
vector1 = [y_av2,y_av2_stein4-60.]
vector2 = [y_av2_trop,y_av2_trop_stein4+50.]
vector3 = [y_av2_extratrop,y_av2_extratrop_stein4-70.]
...
#plt.title('US - UMB')
plt.savefig('regional_NUPTAKE.png',bbox_inches="tight")
plt.show()
