...
fi = Dataset('/home/renato/datasets/IHistClm50Bgc_outputs/IHistClm50Bgc/IHistClm50Bgc.NUPTAKE_NPP_FRACTION.nc','r')
...
f1i = Dataset('/home/renato/datasets/IHistClm50Bgc_outputs/IHistClm50BgcSulman/IHistClm50BgcSulman.NUPTAKE_NPP_FRACTION.nc','r')
...
f2i = Dataset('/home/renato/datasets/IHistClm50Bgc_outputs/IHistClm50BgcSteidinger/IHistClm50BgcSteidinger.NUPTAKE_NPP_FRACTION.nc','r')
...
f3i = Dataset('/home/renato/datasets/IHistClm50Bgc_outputs/IHistClm50BgcSoudzi/IHistClm50BgcSoudzi.NUPTAKE_NPP_FRACTION.nc','r')
...
f4i = Dataset('/home/renato/datasets/IHistClm50Bgc_outputs/ISSP585Clm50BgcCrop_all/ISSP585Clm50BgcCrop_all.NUPTAKE_NPP_FRACTION.nc','r')
...
y_av2 = smooth1(averagei[:],12)
y_av2_trop = smooth1(averagei_trop[:],12)*(tropic_land)
y_av2_extratrop = smooth1(averagei_extratrop[:],12)*(1.-tropic_land)

#######
y_av2_stein1 = smooth1(averagei_stein1[:],12)
y_av2_trop_stein1 = smooth1(averagei_trop_stein1[:],12)*(tropic_land)
y_av2_extratrop_stein1 = smooth1(averagei_extratrop_stein1[:],12)*(1.-tropic_land)


y_av2_stein2 = smooth1(averagei_stein2[:],12)
y_av2_trop_stein2 = smooth1(averagei_trop_stein2[:],12)*(tropic_land)
y_av2_extratrop_stein2 = smooth1(averagei_extratrop_stein2[:],12)*(1.-tropic_land)
y_av2_stein3 = smooth1(averagei_stein3[:],12)
y_av2_trop_stein3 = smooth1(averagei_trop_stein3[:],12)*(tropic_land)
y_av2_extratrop_stein3 = smooth1(averagei_extratrop_stein3[:],12)*(1.-tropic_land)
y_av2_stein4 = smooth1(averagei_stein4[:],12)
y_av2_trop_stein4 = smooth1(averagei_trop_stein4[:],12)*(tropic_land)
y_av2_extratrop_stein4 = smooth1(averagei_extratrop_stein4[:],12)*(1.-tropic_land)
...
##### AV1 IS NUPTAKE
ax1.plot(time,100.*y_av2/1,'r',label='Global')
ax1.plot(time,100.*y_av2_trop/1,'g',label='Tropical')
ax1.plot(time,100.*y_av2_extratrop/1,'b',label='Extra-Tropical')
ax1.plot(time,100.*y_av2_stein1/1,'r',alpha=0.3)
ax1.plot(time,100.*y_av2_trop_stein1/1,'g',alpha=0.3)
ax1.plot(time,100.*y_av2_extratrop_stein1/10e8,'b',alpha=0.3)
ax1.plot(time,100.*y_av2_stein2/1,'r',alpha=0.4)
ax1.plot(time,100.*y_av2_trop_stein2/1,'g',alpha=0.4)
ax1.plot(time,100.*y_av2_extratrop_stein2/1,'b',alpha=0.4)
ax1.plot(time,100.*y_av2_stein3/1,'r',alpha=0.5)
ax1.plot(time,100.*y_av2_trop_stein3/1,'g',alpha=0.5)
ax1.plot(time,100.*y_av2_extratrop_stein3/1,'b',alpha=0.5)
ax1.plot(time_future[3:732] + end + (30*12*5),100.*y_av2_stein4[3:732] + 1.44 ,'r--')
ax1.plot(time_future[3:732] + end + (30*12*5),100.*y_av2_trop_stein4[3:732] + 0.69 ,'g--')
ax1.plot(time_future[3:732] + end + (30*12*5),100.*y_av2_extratrop_stein4[3:732] + 0.81 ,'b--')
...
ax1.set_ylabel(r'% of NPP used for N uptake')
#plt.xlabel('year')
ax1.set_xlabel('year')
#best location
...
vector1 = [100.*y_av2/1,100.*y_av2_stein4/1 + 1.44]
vector2 = [100.*y_av2_trop/1,100.*y_av2_trop_stein4/1 + 0.69]
vector3 = [100.*y_av2_extratrop/1,100.*y_av2_extratrop_stein4/1 + 0.81]
...
#plt.title('US - UMB')
plt.savefig('regional_NPP_NPP_NUPTAKE.png',bbox_inches="tight")
plt.show()
